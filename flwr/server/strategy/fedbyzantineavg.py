...
class FedByzantineAvg(Strategy):
    ...
    def initialize_parameters(
        ...
        if isinstance(initial_parameters, list):
            ...
            initial_parameters = ndarrays_to_parameters(ndarrays=initial_parameters)
    ...
    def evaluate(
        ...
        eval_res = self.eval_fn(server_round, parameters_ndarrays, {})
        if eval_res is None:
            return None
    ...
    def aggregate_fit(
        ...
        byzantine_results = [
            (parameters_to_ndarrays(fit_res.parameters), client)
        ...
        server_weights = parameters_to_ndarrays(self.parameters)
        new_server_weights = aggregate_byzantine(
            byzantine_results, server_weights, byzantine_config
        )

        return ndarrays_to_parameters(new_server_weights), {}
