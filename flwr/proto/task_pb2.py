...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        flwr_dot_proto_dot_transport__pb2.DESCRIPTOR,
    ],
)
...
_TASK = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="producer",
            full_name="flwr.proto.Task.producer",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="consumer",
            full_name="flwr.proto.Task.consumer",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="created_at",
            full_name="flwr.proto.Task.created_at",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="delivered_at",
            full_name="flwr.proto.Task.delivered_at",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="ancestry",
            full_name="flwr.proto.Task.ancestry",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="legacy_server_message",
            full_name="flwr.proto.Task.legacy_server_message",
            index=6,
            number=101,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="legacy_client_message",
            full_name="flwr.proto.Task.legacy_client_message",
            index=7,
            number=102,
            type=11,
            cpp_type=10,
...
_TASKINS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="task_id",
            full_name="flwr.proto.TaskIns.task_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="group_id",
            full_name="flwr.proto.TaskIns.group_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="workload_id",
            full_name="flwr.proto.TaskIns.workload_id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="task",
            full_name="flwr.proto.TaskIns.task",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_TASKRES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="task_id",
            full_name="flwr.proto.TaskRes.task_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="group_id",
            full_name="flwr.proto.TaskRes.group_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="workload_id",
            full_name="flwr.proto.TaskRes.workload_id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="task",
            full_name="flwr.proto.TaskRes.task",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
].message_type = flwr_dot_proto_dot_transport__pb2._SERVERMESSAGE
_TASK.fields_by_name[
    "legacy_client_message"
].message_type = flwr_dot_proto_dot_transport__pb2._CLIENTMESSAGE
