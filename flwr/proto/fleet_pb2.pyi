...
class PullTaskInsResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["reconnect", b"reconnect"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "reconnect", b"reconnect", "task_ins_list", b"task_ins_list"
        ],
    ) -> None: ...
...
class PushTaskResResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "reconnect", b"reconnect", "results", b"results"
        ],
    ) -> None: ...
