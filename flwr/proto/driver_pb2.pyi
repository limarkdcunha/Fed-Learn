...
class GetNodesResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["node_ids", b"node_ids"]
    ) -> None: ...
...
class PushTaskInsRequest(google.protobuf.message.Message):
    ...
    def task_ins_list(
        ...
        flwr.proto.task_pb2.TaskIns
    ]: ...
    def __init__(
        self,
        *,
        task_ins_list: typing.Optional[
            typing.Iterable[flwr.proto.task_pb2.TaskIns]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["task_ins_list", b"task_ins_list"]
    ) -> None: ...
...
class PushTaskInsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["task_ids", b"task_ids"]
    ) -> None: ...
...
class PullTaskResRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["node", b"node"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["node", b"node", "task_ids", b"task_ids"],
    ) -> None: ...
...
class PullTaskResResponse(google.protobuf.message.Message):
    ...
    def task_res_list(
        ...
        flwr.proto.task_pb2.TaskRes
    ]: ...
    def __init__(
        self,
        *,
        task_res_list: typing.Optional[
            typing.Iterable[flwr.proto.task_pb2.TaskRes]
        ] = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["task_res_list", b"task_res_list"]
    ) -> None: ...
