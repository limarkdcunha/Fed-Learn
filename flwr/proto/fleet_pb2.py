...
_PULLTASKINSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="node",
            full_name="flwr.proto.PullTaskInsRequest.node",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="task_ids",
            full_name="flwr.proto.PullTaskInsRequest.task_ids",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_PULLTASKINSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="reconnect",
            full_name="flwr.proto.PullTaskInsResponse.reconnect",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="task_ins_list",
            full_name="flwr.proto.PullTaskInsResponse.task_ins_list",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PUSHTASKRESREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="task_res_list",
            full_name="flwr.proto.PushTaskResRequest.task_res_list",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PUSHTASKRESRESPONSE_RESULTSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="flwr.proto.PushTaskResResponse.ResultsEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="flwr.proto.PushTaskResResponse.ResultsEntry.value",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
_PUSHTASKRESRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="reconnect",
            full_name="flwr.proto.PushTaskResResponse.reconnect",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="results",
            full_name="flwr.proto.PushTaskResResponse.results",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _PUSHTASKRESRESPONSE_RESULTSENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_RECONNECT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="reconnect",
            full_name="flwr.proto.Reconnect.reconnect",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
...
_PUSHTASKRESRESPONSE.fields_by_name[
    "results"
].message_type = _PUSHTASKRESRESPONSE_RESULTSENTRY
